...
public class upd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet upd</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet upd at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    PrintWriter out = response.getWriter();
        ...
        try {
                ...
                int i=stmt.executeUpdate("update stndt set Firstname='"+_firstname+"', Lastname='"+ _lastname+"', Dob='"+dob+"',Address='"+addr +"' where Rollno="+rno+";");
                out.println(i);
                connection.close();
